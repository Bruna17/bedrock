...
vpn-landing-faq-info-question-desc = We don’t log, track, or share any of your network activity. We adhere strictly to { -brand-name-mozilla }’s <a href="{ $url }">Data Privacy Principles</a>, and we only collect the most minimal data required to keep the VPN operational and improve the product over time.
