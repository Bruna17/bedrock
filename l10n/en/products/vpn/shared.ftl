...
## Pricing options. Some offers may only shown in select countries (e.g. German and France).
...
# Variables:
#   $amount (string) - monthly subscription price using localized currency e.g. 'US$4.99/month'
...
# Variables:
#   $amount (string) - total annual price using localized currency e.g. '35,94 € total'
